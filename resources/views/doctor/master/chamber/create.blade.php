        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-md-3">
              ...
              <input type="text" name="chamber_name" id="chamber_name" class="form-control" required>
            </div>
            <div class="col-md-3">
              <label>Chamber Address <span style="color: red;font-weight: bold;">*</span></label>
              <input type="text" name="chamber_address" id="chamber_address" class="form-control" required>
            </div>
            <div class="col-md-3">
